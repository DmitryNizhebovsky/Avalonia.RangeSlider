...
using ModernControls.Avalonia.Controls.Primitives;
using RangeBase = ModernControls.Avalonia.Controls.Primitives.RangeBase;

namespace ModernControls.Avalonia.Controls
{
    /// <summary>
